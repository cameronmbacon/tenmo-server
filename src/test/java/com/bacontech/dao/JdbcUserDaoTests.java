package com.bacontech.dao;

import com.bacontech.tenmo.dao.JdbcUserDao;
import com.bacontech.tenmo.exception.DaoException;
...
public class JdbcUserDaoTests extends BaseDaoTests {
    ...
    public void getUserByUsername_given_invalid_username_returns_null() {
        Assert.assertNull(sut.findUserByUsername("invalid"));
    }

    @Test
    public void getUserByUsername_given_valid_user_returns_user() {
        User actualUser = sut.findUserByUsername(USER_1.getUsername());
    ...
    public void createUser_creates_a_user() {
        ...
        User createdUser = sut.saveUser(user);

        Assert.assertNotNull(createdUser);

        User retrievedUser = sut.findUserByUsername(createdUser.getUsername());
